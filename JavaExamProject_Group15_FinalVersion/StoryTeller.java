...
public class StoryTeller {
    ...
    public boolean chapterComplete() {
        switch (this.currentChapter) {
            ...
            case 2:
                return Rooms.ROOM_SURGERY.getInventory().checkAvailable(Items.ITEM_MOTHER_PATIENT)&&!Rooms.ROOM_SURGERY.getInventory().getItem(Items.ITEM_BISTOURY).getStationary();
        }
