...
//        }
//    },
    ACTIONS_DISINFECT("disinfect", "disinfect surgery tools", new String[]{"sterilize"}) {
        public void executeAction(Items item) {
            if (item.getStationary() != false) {
                System.out.println("It is being disinfected…………");
                try {
                    for (int i = 3; i > 0; i--) {
                        System.out.println("wait " + i + "m...");
                        Thread.sleep(1000); // 1000 milliseconds = 1 second
                ...
                item.setStationary(false);
                System.out.println(item.getAliases()+" "+"has been successfully disinfected.");
            }
        }
    },
    ...
    public void printInformation() {
        this.entityData.printInformation();
    }
