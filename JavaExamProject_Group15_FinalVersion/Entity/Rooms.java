...
public enum Rooms {
    ...
    static {
        ...
        ROOM_HALLWAY.addExits(ROOM_ICU, ROOM_SURGERY, ROOM_RECEPTION_DESK,ROOM_LABORATORY,ROOM_Ultrasonic);
        ROOM_LABORATORY.addExits(ROOM_Ultrasonic,ROOM_HALLWAY);
        ROOM_Ultrasonic.addExits(ROOM_LABORATORY,ROOM_HALLWAY);
        ROOM_PHARMACY.addExits(ROOM_RECEPTION_DESK);
        ROOM_OFFICE.addExits(ROOM_RECEPTION_DESK,ROOM_PHARMACY);
